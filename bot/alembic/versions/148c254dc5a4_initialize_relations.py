...
Revision ID: 148c254dc5a4
Revises: 
Create Date: 2022-04-07 15:58:28.588052
...
def upgrade():
    ...
    op.create_table('QuestionAnswerGroup',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created', sa.DateTime(), server_default='NOW()', nullable=True),
...
def downgrade():
    ...
    op.drop_table('QuestionAnswerGroup')
    op.drop_table('User')
